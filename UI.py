...
class MainUI(QWidget):
    ...
    def initFilePathModule(self):
        ...
        self.src_show_box.setStyleSheet("QLabel{border:1px solid rgb(180, 180, 180);}")
        ...
        self.dst_show_box.setStyleSheet("QLabel{border:1px solid rgb(180, 180, 180);}")
    ...
    def initStatusModule(self):
        ...
        self.x_box.setStyleSheet("QLabel{border:1px solid rgb(180, 180, 180);}")
        separate1 = QLabel(',', self)
        separate1.setFixedSize(20, 22)
        y_lbl = QLabel('Y :', self)
        y_lbl.setFixedSize(16, 22)
        self.y_box = QLabel(self)
        self.y_box.setFixedSize(60, 22)
        self.y_box.setStyleSheet("QLabel{border:1px solid rgb(180, 180, 180);}")
